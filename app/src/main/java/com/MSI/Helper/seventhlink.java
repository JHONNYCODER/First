...
public class seventhlink extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.seventh_link);
...
class CheckNetwork7 {
    ...
    private static final String TAG = CheckNetwork7.class.getSimpleName();
